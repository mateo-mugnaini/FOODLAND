...
const data = {
	...
	products: [
...

		{
			...
			price: 4.26,
			description: "Challenge Butter, Sea Salted, Spreadable Butter with Canola Oil 15 oz Tub",
			image:
...

		{
			...
			price: 551,
			description: "YoCrunch Low Fat Vanilla with M&Ms Yogurt, 4 Oz. Cups, 4 Count",
			image:
...

		{
			...
			price: 2.48,
			description: "Great Value Singles American Pasteurized Prepared Cheese Product, 16 oz, 24",
			image:
		...
		},
		{
			...
			price: 7.64,
			description: "Freshness Guaranteed Thin-Sliced Chicken Breasts, 1.7 - 3.0 lb",
			image:
...

		{
			...
			price: 6.02,
			description: "Foster Farms Fresh & Natural Cage Free Family Pack Chicken Thighs 64 -88 oz (4-5.5 lb) Tray",
			image:
...

		{
			...
			price: 8.50,
			description: "Marketside Antibiotic-Free Thin-Sliced Chicken Breast, 1.1-1.7 lb",
			image:
...

		{
			...
			price: 10990,
			description: "Great Value Frozen Tilapia Skinless & Boneless Fillets, 2 lb",
			image:
...

		{
			...
			price: 5.62,
			description: "Great Value Frozen Cooked Extra Small Peeled & Deveined, Tail-off Shrimp, 12 oz (100-150 Count per lb)",
			image:
...

		{
			...
			price: 3.28,
			description: "Health-Ade Probiotic Kombucha Tea, Pink Lady Apple, 16 fl oz",
			image:
...

		{
			...
			price: 1.68,
			description: "Minute Maid Fruit Punch Real Fruit Juice Drink, 59 fl oz Carton",
			image:
...

		{
			...
			price: 5.98,
			description: "Pure Life Purified Water, 16.9 Fl Oz / 500 mL, Plastic Bottled Water (35 Pack)",
			image:
...

		{
			...
			price: 31.98,
			description: "Jack Daniel's Old No. 7 Tennessee Whiskey, 1.75 L Bottle, 80 Proof",
			image:
...

		{
			...
			price: 16786,
			description: "Blue Moon Belgian White Wheat Ale Beer, 12 Pack, 12 fl oz Bottles, 5.4% ABV",
			image:
...

		{
			...
			price: 11.47,
			description:
				"Head and Shoulders Dandruff Shampoo, Classic Clean, 28 oz",
			image:
...

		{
			...
			price: 1.24,
			description:
				"Softsoap Liquid Hand Soap Pump, Fresh Breeze, 7.5 oz",
			image:
...

		{
			...
			price: 6.97,
			description: "Secret Solid Antiperspirant Deodorant, Powder Fresh 2.7 oz, Twin Pack",
			image:
...

		{
			...
			price: 6.78,
			description:
				"NIVEA MEN Sensitive Shave Gel, 2 pack",
			image:
...

		{
			...
			price: 24.97,
			description:
				"Wild Willies Beard Growth Supplement, 60 Capsules",
			image:
...

		{
			...
			price: 17.97,
			description:
				"Gillette Fusion5 Men's Razor Blade Refills, 4 Count",
			image:
...

		{
			...
			price: 2.98,
			description: "Freshness Guaranteed Chocolate Chip Cookies, 14 oz, 10 Count",
			image:
...

		{
			...
			price: 5.24,
			description: "Freshness Guaranteed Apple Turnover Pastries, 10 oz, 4 Count",
			image:
...

		{
			...
			price: 4.98,
			description: "Freshness Guaranteed Mini Iced Cinnamon Rolls, Kosher, 13oz, 16 Count",
			image:
...

		{
			...
			price: 1139,
			description: "Freshness Guaranteed Frosted Sugar Cookies, 13.5 oz, 10 Count",
			image:
...

		{
			...
			price: 5.87,
			description: "Marketside Bite Sized Chocolate Chip Cookies, 12 oz, 48 Count",
			image:
...

		{
			...
			price: 618.99,
			description: "SAMSUNG 50-inch QLED Q60B Series 4K UHD Dual LED Quantum HDR Smart TV with Additional 2 Year Coverage by Epic Protect (2022)'",
			image:
...

		{
			...
			price: 48.28,
			description: "Onn. 23 mile Walkie Talkie 3pk with Two Way Radios, LED Light",
			image:
...

		{
			...
			price: 49,
			description: "Canon PIXMA TS3522 All-In-One Wireless InkJet Printer with Print, Copy and Scan Features",
			image:
...

		{
			...
			price: 139,
			description: "VANKYO Leisure 470 HD Mini Wifi Projector with Roku Express Streaming Player, 50000 Hrs LED Life, 240'' Display Screen for Home Theater & Outdoor Movies",
			image:
...

		{
			...
			price: 149,
			description: "Samsung Chromebook 4, 11.6 HD, Intel Celeron N4020, 4GB RAM, 32GB Storage, ChromeOS, Platinum Titan, XE310XBA-K01US",
			image:
...

		{
			...
			price: 224.00,
			description: "Galanz 4.6. Cu ft Two Door Mini Refrigerator with Freezer, Stainless Steel",
			image:
...

		{
			...
			price: 876.82,
			description: "GE GTW465ASNWW 27 Inch Top Load Washer with 4.5 cu. ft. Capacity, 14 Wash Cycles, 750 RPM, Speed Wash in White",
			image:
...

		{
			...
			price: 1299.00,
			description: "ASUS ROG R7 3060 Laptop; ASUS ROG Strix G15 15.6 WQHD, AMD Ryzen 7 6800H, NVIDIA GeForce RTX 3060 Graphics, 16GB RAM, 1TB SSD, Eclipse Gray, Windows 11 Home, G513RM-WS74",
			image:
...

		{
			...
			price: 639.99,
			description: "Sony PlayStation 5 Digital Console with Extra Purple Dualsense Controller and Accessories Kit (PS5, PlayStation Digital Version)",
			image:
...

		{
			...
			price: 5.18,
			description: "Clorox Toilet Bowl Cleaner Bleach, Rain Clean, 24 fl oz, 2 Pack",
			image:
...

		{
			...
			price: 2500,
			description: "Lysol Multi-Surface Cleaner, Sanitizing and Disinfecting Pour, to Clean and Deodorize, Sparkling Lemon and Sunflower Essence, 90 Fl Oz.",
			image:
...

		{
			...
			price: 4.27,
			description: "Scrubbing Bubbles Bathroom Grime Fighter Aerosol, Disinfectant Spray; Effective Tile, Bathtub, Shower and Overall Bathroom Cleaner (1 Aerosol Spray), Rainshower, 20 Oz",
			image:
...

		{
			...
			price: 5.22,
			description: "EASY-OFF Fume Free Oven Cleaner Spray, Lemon 14.5 oz, Removes Grease",
			image:
...

		{
			...
			price: 558,
			description: "Scrubbing Bubbles Fresh Gel Toilet Cleaning Stamp, Rainshower, Dispenser with 6 Gel Stamps, 1.34 Oz",
			image:
...

		{
			...
			price: 5.97,
			description: "The Pink Stuff, Miracle Cleaning Paste, All-Purpose Cleaner, 17.63 oz.",
			image:
...

		{
			...
			price: 5.54,
			description: "CLR Calcium Lime and Rust Remover, Multi-Use Household Cleaner, EPA Safer Choice, 28 oz",
			image:
...

		{
			...
			price: 5.38,
			description: "Pledge Clean It Dust & Allergen Multisurface Cleaner Spray, Lemon Scent, 9.7 Ounce",
			image:
...

		{
			...
			price: 8.99,
			description: "Mr. Clean Magic Eraser Original Cleaning Pads with Durafoam, 9 Ct",
			image:
...

		{
			...
			price: 3.01,
			description: "Cleaning Supplies Clearance Universal Cleaning Powder A Good Cleaning Product Is A Unique Gift For Family And Friends All Purpose Cleaning Powder",
			image:
...

		{
			...
			price: 4.24,
			description: "Atkins Roasted Turkey with Garlic Mashed Cauliflower Meal 9 Oz. (Frozen Dinner)",
			image:
...

		{
			...
			price: 3.28,
			description: "Healthy Choice Café Steamers Sweet & Sour Chicken Frozen Meal, 10 oz (Frozen)",
			image:
...

		{
			...
			price: 7.62,
			description: "TGI Fridays Loaded Cheddar & Bacon Potato Skins Frozen Snacks & Appetizers, 13.5 oz Box",
			image:
...

		{
			...
			price: 6.28,
			description: "Delimex Beef Corn Taquitos Frozen Snacks & Appetizers, 23 ct Box",
			image:
...

		{
			...
			price: 7.24,
			description: "Foster Farms Bite-sized Chicken Frank Mini Corndogs Fully Cooked 29.3 oz (1.83 lb) bag",
			image:
...

		{
			...
			price: 2.82,
			description: "Great Value Regular Cut French Fried Potatoes, 32 oz (Frozen)",
			image:
...

		{
			...
			price: 10.48,
			description: "Jimmy Dean Pancakes & Sausages on a Stick, 30 oz, 12 Count (Frozen)",
			image:
...

		{
			...
			price: 5.78,
			description: "Great Value Croissant Sandwiches Sausage Egg and Cheese, 4 Count (Frozen)",
			image:
...

		{
			...
			price: 13.48,
			description: "Stouffer's Baked Ziti Large Family Size Frozen Frozen Meal, 57 oz (Frozen)",
			image:
...

		{
			...
			price: 12.99,
			description: "12 Reusable 10.5 Plastic Paper Plate Holders in bright colors (12 Pack)",
			image:
...

		{
			...
			price: 6.98,
			description: "Vanity Fair Everyday Disposable Paper Napkins, White, 300 Count",
			image:
...

		{
			...
			price: 20.99,
			description: "Comfy Package [Combo Box] 360 Clear Disposable Plastic Silverware Flatware Sets",
			image:
...

		{
			...
			price: 29019,
			description: "Hefty Party On Disposable Plastic Cups, Red, 18 Ounce, 50 Count",
			image:
...

		{
			...
			price: 18.20,
			description: "BAKER DEPOT 17 oz Plastic Tumblers Drinking Glasses Clear Acrylic Cups Wine Glassware Beverage Drinkware Tumbler for Poolside Party",
			image:
...

		{
			...
			price: 19900,
			description: "100 Pack 5oz Heart shaped Clear Plastic Dessert Cups with Spoons, Appetizer Serving Cups for Desserts, Appetizers, Puddings, Mousse",
			image:
...

		{
			...
			price: 4.98,
			description: "STEADY Creative Style Household Plastic Cups With Handles Thick Drop Resistant Bottle - Orange",
			image:
...

		{
			...
			price: 8.99,
			description: "OUNONA Ceramic Soup Bowl Cups Bowl Baking Cups Bowls Bowls Ramekins Yogurt Dish Chic Dishes Dessert Ramekins Ice Dish Sauce",
			image:
...

		{
			...
			price: 19.39,
			description: "DanceeMangoo 2 Liters Water Bottle Motivational Drinking Bottle Sports Bottles With Time Marker Stickers Plastic Cups For Girls Free Shipping",
			image:
...

		{
			...
			price: 13.49,
			description: "DabuLiu 2 Liters Water Bottle Motivational Drinking Bottle Sports Water Bottle With Time Marker Stickers Portable Reusable Plastic Cups",
			image:
...

		{
			...
			price: 27.99,
			description: "Gezond 50 Pack 14-inch Disposable Food Serving Trays Heavy-Duty Compostable Sugarcane Platters Large Paper Plates for Crawfish Serving",
			image:
...

		{
			...
			price: 18.97,
			description: "Ibambo Natural Bamboo Cutlery 100 Set (50 Forks, 25 Spoons, 25 Knives)",
			image:
...

		{
			...
			price: 16.80,
			description: "Jumbo Smoothie Straws - 8.5 High Assorted Colors Milkshake Straws [100 Pack]",
			image:
...

		{
			...
			price: 5.99,
			description: "NUOLUX Spoon Spoons Mini Scoops Laboratory Micro Medicine Powder Shovelmeasuring Spatula Filling Silverware Gold Disposable",
			image:
...

		{
			...
			price: 18.98,
			description: "IAMS PROACTIVE HEALTH Hairball Care Chicken and Salmon Dry Cat Food for Adult Cat, 7 lb. Bag",
			image:
...

		{
			...
			price: 12.78,
			description: "Nylabone Gourmet Style Dog Chew Toy Stick Chicken X-Large/Souper (1 Count)",
			image:
...

		{
			...
			price: 9.97,
			description: "Nerf Dog Vortex Chain Tug Dog Toy with Durable Braided Nylon, 25",
			image:
...

		{
			...
			price: 159.20,
			description: "MidWest Homes For Pets Hard-Sided Dog/Cat Carrier, Green, Inside Dims 20.70L x 13.22W x 14.09H & Suitable for Tiny Dog Breeds Perfect Dog Kennel Travel Carrier for Quick Trips",
			image:
...

		{
			...
			price: 7.99,
			description: "Purina Beneful Baked Delights Real Beef & Cheese Crunchy Treats for Dogs, 8.5 oz Pouch",
			image:
...

		{
			...
			price: 20.99,
			description: "CRAVE Grain Free Indoor Adult Dry Cat Food with Protein from Chicken & Salmon, 4 lb. Bag",
			image:
...

		{
			...
			price: 39.84,
			description: "Purina Pro Plan Duck Entree Wet Cat Food, Grain-Free, 3 oz Cans (24 Pack)",
			image:
...

		{
			...
			price: 52.98,
			description: "Purina Pro Plan Indoor Hairball Turkey Rice Dry Cat Food, 16 lb Bag",
			image:
...

		{
			...
			price: 29.99,
			description: "Milk-Bone Soft and Chewy Dog Treats Made With Real Bacon, 5.6 Oz. Bag (Pack of 10)",
			image:
...

		{
			...
			price: 39.99,
			description: "PAWZ Road 32 Cat Tree Tower with Cactus Sisal Scratching Posts for Indoor Small Cats, Green",
			image:
...

		{
			...
			price: 6.48,
			description: "TEMPTATIONS Meaty Bites, Soft and Savory Cat Treats, Salmon Flavor, 4.12 oz. Pouch",
			image:
...

		{
			...
			price: 25.97,
			description: "Gap Rugby Stripe Cuddler Pet Bed, Recycled Polyester Cover with Sherpa inner, Small 2018, Navy",
			image:
...

		{
			...
			price: 10.99,
			description: "HESLAND Dog Chew Toothbrush Toys, Squeaky Teeth Cleaning Toy for Aggressive Chewers Small Medium Large Breed Indestructible Tough Dogs Dental Care",
			image:
...

		{
			...
			price: 4.92,
			description: "Caf Bustelo, Espresso Style Dark Roast Ground Coffee, 10 oz. Can",
			image:
...

		{
			...
			price: 4.12,
			description: "Betty Crocker REESE'S Peanut Butter Premium Brownie Mix, 16 oz.",
			image:
...

		{
			...
			price: 3.13,
			description: "Nestle Toll House Semi Sweet Chocolate Baking Chips, 12 oz Bag",
			image:
...

		{
			...
			price: 4.66,
			description: "HERSHEY'S Natural Unsweetened Ingredient, Gluten Free, No Preservatives",
			image:

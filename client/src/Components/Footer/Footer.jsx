    ...
    <div name="ContainterFooter" className="ContainterFooter">
      ...
      <div name="Menu" className="MenuFooter">
        <div name="contact" className="contact">
          <h2>Developed by:</h2>
          <a href="https://www.linkedin.com/in/Baesp" target="_blank" key="Linkeding2" className="linksFooter">
            <img src={linked} alt="logoLink" className="Linke" />
            Bárbara Espinola
          </a>
          <a href="https://www.linkedin.com/in/mateo-mugnaini/" target="_blank" key="Linkeding3" className="linksFooter">
            <img src={linked} alt="logoLink" className="Linke" />
            Mateo Mugnaini
          </a>
          <a href="https://www.linkedin.com/in/sofia-perone-298842209/" target="_blank" key="Linkeding1" className="linksFooter">
            <img src={linked} alt="logoLink" className="Linke" />
            Sofia Perone
          </a>
          <a href="http://www.linkedin.com/in/cepalomos" target="_blank" key="Linkeding4" className="linksFooter">
            <img src={linked} alt="logoLink" className="Linke" />
          ...
          <a href="http://www.linkedin.com/in/camilop4" target="_blank" key="Linkeding6" className="linksFooter">
            <img src={linked} alt="logoLink" className="Linke" />
        ...
        <div name="RegisterEmail">
          ...
          <img
            ...
            alt="FBIcon"
            src="https://tinypic.host/images/2023/04/27/facebook.png"
          />
          <img
            name="iconFooterSocial"
            className="iconFooterSocial"
            alt="IGICon"
            src="https://tinypic.host/images/2023/04/27/instagram.png"
          />
          <img
            name="iconFooterSocial"
            className="iconFooterSocial"
            alt="WAICon"
            src="https://tinypic.host/images/2023/04/27/whatsapp.png"
          />
          <a href="https://www.soyhenry.com/">
            <img
              src="https://tinypic.host/images/2023/04/26/logoOG.png"
              name="LogoHenry"
              alt="LogoHenry"
              className="LogoHenry"
            ></img>

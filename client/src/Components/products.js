export const products = [
  ...
  {
    name: "Lavavajilla Magistral Ultra Limon 500ml",
    slug: "Lavavajilla Magistral Limon",
    price: 739,
    description: "Lavavajilla Magistral Ultra Limon 500ml",
    image:
      "https://jumboargentina.vtexassets.com/arquivos/ids/755230-800-auto?v=638023198606230000&width=800&height=auto&aspect=true",
    stock: 21,
    isDeleted: false,
    comments: [],
    category: "Limpieza",
    ...
    {
    name: "Manteca Casanto 200g",
    slug: "Manteca",
    price: 739,
    description: "Manteca Casanto 200g",
    image:
  ...
  {
    name: "Patitas De Pollo Granja Del Sol 400g",
    slug: "Patitas De Pollo Granja Del Sol",
    price: 739,
    description: "Patitas De Pollo Granja Del Sol 400g no prefritas",
    image:
      "https://jumboargentina.vtexassets.com/arquivos/ids/771612-800-auto?v=638132062668630000&width=800&height=auto&aspect=true",
    stock: 15,
    isDeleted: false,
    comments: [],
    category: "Congelados",
  ...
  {
    name: "Aderezo Mayonesa Natura 475 Gr",
    slug: "Aderezo Mayonesa Natura",
    price: 739,
    description: "Aderezo Mayonesa Natura 475 Gr con jugo de limon",
    image:
      "https://jumboargentina.vtexassets.com/arquivos/ids/685480-800-auto?v=637786569809200000&width=800&height=auto&aspect=true",
    stock: 15,
    isDeleted: false,
    comments: [],
    category: "Almacen",
